...
`;let Pe=class extends(ae(it)){constructor(){super(...arguments),this._compare=!1,this._showCompareCalendar=!1,this._lastSyncToEntityTimestamp=0,this._lastSyncFromEntityTimestamp=0,this._userActionTimestamp=0,this._isUserAction=!1,this._isProcessingClick=!1,this._lastClickId=0,this._clickDebounceTimer=null}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}async firstUpdated(){const t=await window.loadCardHelpers();t.importMoreInfoControl("input_datetime");try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}try{await t.importMoreInfoControl("selector")}catch(t){console.warn("Failed to load ha-selector component:",t)}const e=["button-toggle-group","ha-button-toggle-group","selector-button-toggle","ha-selector-button-toggle"];for(const o of e)try{await t.importMoreInfoControl(o);break}catch(t){console.warn(`Failed to load ${o}:`,t)}try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}setTimeout(()=>{this._forceButtonStyling()},1e3)}hassSubscribe(){var t;const e=[re(this.hass,{key:this.collectionKey}).subscribe(t=>this._updateDates(t))];return(null===(t=this._config)||void 0===t?void 0:t.sync_entity)&&e.push(this.hass.connection.subscribeEvents(t=>this._handleEntityStateChange(t),"state_changed")),e}render(){var t,e,o,i,n,r,a,s,c,l,d,p,u,h,m,g,_,y,f;if(!this.hass||!this._startDate)return L;const v=t=>{var e;return"custom"===t?(null===(e=this._config)||void 0===e?void 0:e.custom_period_label)||Ae(`toggleButtons.${t}`)||t:this.hass.localize(`ui.components.calendar.event.rrule.${t}`)},b=(null===(t=this._config)||void 0===t?void 0:t.period_buttons)?this._config.period_buttons.map(t=>({label:v(t),value:t})):[{label:this.hass.localize("ui.components.calendar.event.rrule.day"),value:"day"},{label:this.hass.localize("ui.components.calendar.event.rrule.week"),value:"week"},{label:this.hass.localize("ui.components.calendar.event.rrule.month"),value:"month"},{label:this.hass.localize("ui.components.calendar.event.rrule.year"),value:"year"}],x=(null===(e=this._config)||void 0===e?void 0:e.layout_mode)||"standard",w=j`
    ...
    `,$=j` <button class="today-button-custom" @click=${this._pickToday}>
      ${(null===(r=this._config)||void 0===r?void 0:r.today_button_label)||Ae("toggleButtons.today")}
    </button>`;j` <button class="today-button-fallback" @click=${this._pickToday}>
      ${(null===(a=this._config)||void 0===a?void 0:a.today_button_label)||Ae("toggleButtons.today")}
    </button>`;const S=j` <ha-icon-button
      @click=${this._pickToday}
      class="today-icon"
      .label=${(null===(s=this._config)||void 0===s?void 0:s.today_button_label)||Ae("toggleButtons.today")}
      .path=${dt}
    >
    </ha-icon-button>`,k=!1===(null===(c=this._config)||void 0===c?void 0:c.today_button_type)?L:"icon"===(null===(l=this._config)||void 0===l?void 0:l.today_button_type)?S:$,D="icon"===(null===(d=this._config)||void 0===d?void 0:d.compare_button_type)?j`
      <ha-icon-button
    ...
    `:L,E="text"===(null===(u=this._config)||void 0===u?void 0:u.compare_button_type)?j`
    ...
    `:L,A=j`
      <div class="period-buttons-row">
        ${this._renderPeriodButtons(b)}
        ${D}
      </div>
    `,C=j`
      <div class="date-controls-row">
        ${"custom"===this._period?w:j`
              <div class="date-display">
                ${"day"===this._period?Ft(this._startDate,this.hass.locale):"month"===this._period?Zt(this._startDate,this.hass.locale):"year"===this._period?qt(this._startDate,this.hass.locale):`${Wt(this._startDate,this.hass.locale)} – ${Wt(this._endDate||new Date,this.hass.locale)}`}
              </div>
      ...
      ${this._compare?j`
            <div class="date-controls-row">
              <div class="date-display">
                ${this._compareStartDate?"day"===this._period?Ft(this._compareStartDate,this.hass.locale):"month"===this._period?Zt(this._compareStartDate,this.hass.locale):"year"===this._period?qt(this._compareStartDate,this.hass.locale):`${Wt(this._compareStartDate,this.hass.locale)} – ${Wt(this._compareEndDate||new Date,this.hass.locale)}`:this.hass.localize("ui.panel.lovelace.components.energy_period_selector.compare")}
              </div>
              <div class="navigation-controls">
                <ha-icon-button
      ...
      ${this._showCompareCalendar?j`
            <div class="date-range-container">
              <ha-date-input
                .locale=${this.hass.locale}
                .value=${(null===(g=this._compareStartDate)||void 0===g?void 0:g.toISOString())||""}
                .label=${this.hass.localize("ui.components.date-range-picker.start_date")}
                @value-changed=${this._compareStartDateChanged}
                .required=${!0}
                .min=${"2019-01-01"}
                .max=${(null===(_=this._compareEndDate)||void 0===_?void 0:_.toISOString())||Pt().toISOString()}
              >
              </ha-date-input>
              <ha-date-input
                .locale=${this.hass.locale}
    ...
    `}_valueChanged(t){const e=null==t?void 0:t.detail.value;ze(this,"config-changed",{config:e})}_renderSyncRow(t){var e,o;return j`
      <div class="two-col">
        <div class="field">
    ...
    `}};t([st({attribute:!1})],eo.prototype,"hass",void 0),t([ct()],eo.prototype,"_config",void 0),eo=t([rt("energy-period-selector-editor")],eo);var oo=Object.freeze({__proto__:null,loadHaForm:to,get EnergyPeriodSelectorEditor(){return eo}});export{Ie as EnergyPeriodSelectorPlus};
