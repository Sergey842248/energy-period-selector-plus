...
`;let Pe=class extends(ae(it)){constructor(){super(...arguments),this._compare=!1,this._showCompareCalendar=!1,this._showCustomCalendar=!1,this._lastSyncToEntityTimestamp=0,this._lastSyncFromEntityTimestamp=0,this._userActionTimestamp=0,this._isUserAction=!1,this._isProcessingClick=!1,this._lastClickId=0,this._clickDebounceTimer=null}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}async firstUpdated(){const t=await window.loadCardHelpers();t.importMoreInfoControl("input_datetime");try{await t.importMoreInfoControl("ha-date-range-picker")}catch(t){console.error("Failed to load ha-date-range-picker",t)}try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}try{await t.importMoreInfoControl("selector")}catch(t){console.warn("Failed to load ha-selector component:",t)}const e=["button-toggle-group","ha-button-toggle-group","selector-button-toggle","ha-selector-button-toggle"];for(const o of e)try{await t.importMoreInfoControl(o);break}catch(t){console.warn(`Failed to load ${o}:`,t)}try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}}hassSubscribe(){var t;const e=[re(this.hass,{key:this.collectionKey}).subscribe(t=>this._updateDates(t))];return(null===(t=this._config)||void 0===t?void 0:t.sync_entity)&&e.push(this.hass.connection.subscribeEvents(t=>this._handleEntityStateChange(t),"state_changed")),e}render(){var t,e,o,i,n,r,a,s,c,l,d,p;if(!this.hass||!this._startDate)return L;const u=t=>{var e;return"custom"===t?(null===(e=this._config)||void 0===e?void 0:e.custom_period_label)||Ee(`toggleButtons.${t}`)||t:this.hass.localize(`ui.components.calendar.event.rrule.${t}`)},h=(null===(t=this._config)||void 0===t?void 0:t.period_buttons)?this._config.period_buttons.map(t=>({label:u(t),value:t})):[{label:this.hass.localize("ui.components.calendar.event.rrule.day"),value:"day"},{label:this.hass.localize("ui.components.calendar.event.rrule.week"),value:"week"},{label:this.hass.localize("ui.components.calendar.event.rrule.month"),value:"month"},{label:this.hass.localize("ui.components.calendar.event.rrule.year"),value:"year"}],m=(null===(e=this._config)||void 0===e?void 0:e.layout_mode)||"standard",_=I` <button class="today-button-custom" @click=${this._pickToday}>
      ${(null===(o=this._config)||void 0===o?void 0:o.today_button_label)||Ee("toggleButtons.today")}
    </button>`;I` <button class="today-button-fallback" @click=${this._pickToday}>
      ${(null===(i=this._config)||void 0===i?void 0:i.today_button_label)||Ee("toggleButtons.today")}
    </button>`;const g=I` <ha-icon-button
      @click=${this._pickToday}
      class="today-icon"
      .label=${(null===(n=this._config)||void 0===n?void 0:n.today_button_label)||Ee("toggleButtons.today")}
      .path=${dt}
    >
    </ha-icon-button>`,y=!1===(null===(r=this._config)||void 0===r?void 0:r.today_button_type)?L:"icon"===(null===(a=this._config)||void 0===a?void 0:a.today_button_type)?g:_,f="icon"===(null===(s=this._config)||void 0===s?void 0:s.compare_button_type)?I`
      <ha-icon-button
    ...
    `:L,b="text"===(null===(l=this._config)||void 0===l?void 0:l.compare_button_type)?I`
