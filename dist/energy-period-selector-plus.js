...
`;let Pe=class extends(ae(it)){constructor(){super(...arguments),this._compare=!1,this._showCompareCalendar=!1,this._lastSyncToEntityTimestamp=0,this._lastSyncFromEntityTimestamp=0,this._userActionTimestamp=0,this._isUserAction=!1,this._isProcessingClick=!1,this._lastClickId=0,this._clickDebounceTimer=null}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}async firstUpdated(){const t=await window.loadCardHelpers();t.importMoreInfoControl("input_datetime"),t.importMoreInfoControl("ha-date-range-picker");try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}try{await t.importMoreInfoControl("selector")}catch(t){console.warn("Failed to load ha-selector component:",t)}const e=["button-toggle-group","ha-button-toggle-group","selector-button-toggle","ha-selector-button-toggle"];for(const o of e)try{await t.importMoreInfoControl(o);break}catch(t){console.warn(`Failed to load ${o}:`,t)}try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}}hassSubscribe(){var t;const e=[re(this.hass,{key:this.collectionKey}).subscribe(t=>this._updateDates(t))];return(null===(t=this._config)||void 0===t?void 0:t.sync_entity)&&e.push(this.hass.connection.subscribeEvents(t=>this._handleEntityStateChange(t),"state_changed")),e}render(){var t,e,o,i,n,r,a,s,c,l,d,p;if(!this.hass||!this._startDate)return L;const u=t=>{var e;return"custom"===t?(null===(e=this._config)||void 0===e?void 0:e.custom_period_label)||Ae(`toggleButtons.${t}`)||t:this.hass.localize(`ui.components.calendar.event.rrule.${t}`)},h=(null===(t=this._config)||void 0===t?void 0:t.period_buttons)?this._config.period_buttons.map(t=>({label:u(t),value:t})):[{label:this.hass.localize("ui.components.calendar.event.rrule.day"),value:"day"},{label:this.hass.localize("ui.components.calendar.event.rrule.week"),value:"week"},{label:this.hass.localize("ui.components.calendar.event.rrule.month"),value:"month"},{label:this.hass.localize("ui.components.calendar.event.rrule.year"),value:"year"}],m=(null===(e=this._config)||void 0===e?void 0:e.layout_mode)||"standard",_=I`
      <ha-date-range-picker
        .hass=${this.hass}
      ...
      ></ha-date-range-picker>
    `,g=I` <button class="today-button-custom" @click=${this._pickToday}>
      ${(null===(o=this._config)||void 0===o?void 0:o.today_button_label)||Ae("toggleButtons.today")}
    </button>`;I` <button class="today-button-fallback" @click=${this._pickToday}>
      ${(null===(i=this._config)||void 0===i?void 0:i.today_button_label)||Ae("toggleButtons.today")}
    </button>`;const y=I` <ha-icon-button
      @click=${this._pickToday}
      class="today-icon"
      .label=${(null===(n=this._config)||void 0===n?void 0:n.today_button_label)||Ae("toggleButtons.today")}
      .path=${dt}
    >
    </ha-icon-button>`,f=!1===(null===(r=this._config)||void 0===r?void 0:r.today_button_type)?L:"icon"===(null===(a=this._config)||void 0===a?void 0:a.today_button_type)?y:g,b="icon"===(null===(s=this._config)||void 0===s?void 0:s.compare_button_type)?I`
      <ha-icon-button
      ...
      >
        ${null!==(c=this._config.compare_button_label)&&void 0!==c?c:this.hass.localize("ui.panel.lovelace.components.energy_period_selector.compare")}
      </ha-icon-button>
    `:L,v="text"===(null===(l=this._config)||void 0===l?void 0:l.compare_button_type)?I`
    ...
    `:L,x=I`
      <div class="period-buttons-row">
        ${this._renderPeriodButtons(h)}
        ${b}
      </div>
    `,w=I`
      <div class="date-controls-row">
        ${"custom"===this._period?I`<div class="date-range-picker-container">${_}</div>`:I`
              ...
              <div class="navigation-controls">
                ${!1!==(null===(p=this._config)||void 0===p?void 0:p.prev_next_buttons)?I`
                      <ha-icon-button-prev
      ...
      ${this._showCompareCalendar?I`
            ...
            ></ha-date-range-picker>
          `:L}
    `,$=["energy-period-selector","compact"===m?"compact-mode":"standard-mode"].filter(Boolean).join(" ");return I`
      <div class="${$}">
        ${v}
        ${x}
        ${w}
      </div>
    `}_dateRangeChanged(t){const{startDate:e,endDate:o}=t.detail;this._setDate(e,o)}_compareDateRangeChanged(t){const{startDate:e,endDate:o}=t.detail;this._setCompareDate(e,o)}_handleView(t){this._period=t.detail.value;const e=Mt(),o=!this._startDate||function(t,e){ut(2,arguments);var o=mt(t).getTime(),i=mt(e.start).getTime(),n=mt(e.end).getTime();if(!(i<=n))throw new RangeError("Invalid interval");return o>=i&&o<=n}(e,{start:this._startDate,end:this._endDate||Pt()})?e:this._startDate,i=Rt(this.hass.locale);this._setDate("day"===this._period?$t(o):"week"===this._period?xt(o,{weekStartsOn:i}):"month"===this._period?Ct(o):"year"===this._period?Tt(o):this._startDate||Mt(),"custom"===this._period?this._endDate:void 0)}_pickToday(){const t=Rt(this.hass.locale);this._setDate("day"===this._period?Mt():"week"===this._period?xt(new Date,{weekStartsOn:t}):"month"===this._period?Ct(new Date):Tt(new Date))}_pickPrevious(){const t=++this._lastClickId;this._clickDebounceTimer&&clearTimeout(this._clickDebounceTimer),this._clickDebounceTimer=window.setTimeout(()=>{this._processPickPrevious(t)},300)}_processPickPrevious(t){if(this._isProcessingClick)return;this._isProcessingClick=!0;const e="day"===this._period?_t(this._startDate,-1):"week"===this._period?kt(this._startDate,-1):"month"===this._period?gt(this._startDate,-1):"year"===this._period?St(this._startDate,-1):_t(this._startDate,-1);this._startDate&&Math.abs(e.getTime()-this._startDate.getTime())<1e3?this._isProcessingClick=!1:(this._userActionTimestamp=Date.now(),this._isUserAction=!0,this._setDate(e),setTimeout(()=>{this._isProcessingClick=!1},500))}_pickNext(){const t=++this._lastClickId;this._clickDebounceTimer&&clearTimeout(this._clickDebounceTimer),this._clickDebounceTimer=window.setTimeout(()=>{this._processPickNext(t)},300)}_pickCompareDate(){this._showCompareCalendar=!this._showCompareCalendar}_processPickNext(t){if(this._isProcessingClick)return;this._isProcessingClick=!0;const e="day"===this._period?_t(this._startDate,1):"week"===this._period?kt(this._startDate,1):"month"===this._period?gt(this._startDate,1):"year"===this._period?St(this._startDate,1):_t(this._startDate,1);this._startDate&&Math.abs(e.getTime()-this._startDate.getTime())<1e3?this._isProcessingClick=!1:(this._userActionTimestamp=Date.now(),this._isUserAction=!0,this._setDate(e),setTimeout(()=>{this._isProcessingClick=!1},500))}_setDate(t,e,o=!1){this._startDate=t;const i=Rt(this.hass.locale),n="day"===this._period?At(t):"week"===this._period?function(t,e){var o,i,n,r,a,s,c,l;ut(1,arguments);var d=vt(),p=pt(null!==(o=null!==(i=null!==(n=null!==(r=null==e?void 0:e.weekStartsOn)&&void 0!==r?r:null==e||null===(a=e.locale)||void 0===a||null===(s=a.options)||void 0===s?void 0:s.weekStartsOn)&&void 0!==n?n:d.weekStartsOn)&&void 0!==i?i:null===(c=d.locale)||void 0===c||null===(l=c.options)||void 0===l?void 0:l.weekStartsOn)&&void 0!==o?o:0);if(!(p>=0&&p<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var u=mt(t),h=u.getDay(),m=6+(h<p?-7:0)-(h-p);return u.setDate(u.getDate()+m),u.setHours(23,59,59,999),u}(t,{weekStartsOn:i}):"month"===this._period?function(t){ut(1,arguments);var e=mt(t),o=e.getMonth();return e.setFullYear(e.getFullYear(),o+1,0),e.setHours(23,59,59,999),e}(t):"year"===this._period?function(t){ut(1,arguments);var e=mt(t),o=e.getFullYear();return e.setFullYear(o+1,0,0),e.setHours(23,59,59,999),e}(t):"custom"===this._period&&e?At(e):this._endDate||Pt(),r=re(this.hass,{key:this.collectionKey});r.setPeriod(t,n),r.refresh()}_setCompareDate(t,e){const o=re(this.hass,{key:this.collectionKey});o.setComparePeriod(t,e),o.refresh()}_updateDates(t){this._compare=void 0!==t.startCompare,this._startDate=t.start,this._endDate=t.end||Pt(),this._compareStartDate=t.startCompare,this._compareEndDate=t.endCompare;const e=Et(this._endDate,this._startDate||Pt());this._period="custom"!==this._period?e<1?"day":6===e?"week":e>26&&e<31?"month":364===e||365===e?"year":"custom":"custom"}_toggleCompare(){this._compare=!this._compare,this._compare||(this._showCompareCalendar=!1);const t=re(this.hass,{key:this.collectionKey});t.setCompare(this._compare),t.refresh()}_handleEntityStateChange(t){var e;if(!(null===(e=this._config)||void 0===e?void 0:e.sync_entity)||t.data.entity_id!==this._config.sync_entity)return;const o=this._config.sync_direction||"both";if("from-entity"!==o&&"both"!==o)return;const i=Date.now();if(i-this._lastSyncFromEntityTimestamp<500)return;if(i-this._userActionTimestamp<1e3)return;if(this._isUserAction)return;const n=t.data.new_state;if(!n||!n.attributes)return;const r=this._parseEntityDateTime(n);r&&(this._startDate&&Math.abs(r.getTime()-this._startDate.getTime())<1e3||(this._lastSyncFromEntityTimestamp=i,this._setDate(r,void 0,!0)))}_parseEntityDateTime(t){try{if(t.attributes.has_date&&t.attributes.has_time){const e=t.attributes.year+"-"+String(t.attributes.month).padStart(2,"0")+"-"+String(t.attributes.day).padStart(2,"0"),o=String(t.attributes.hour).padStart(2,"0")+":"+String(t.attributes.minute).padStart(2,"0")+":00";return new Date(e+"T"+o)}if(t.attributes.has_date){const e=t.attributes.year+"-"+String(t.attributes.month).padStart(2,"0")+"-"+String(t.attributes.day).padStart(2,"0");return new Date(e+"T00:00:00")}if("string"==typeof t.state){const e=new Date(t.state);if(!isNaN(e.getTime()))return e}return null}catch(t){return console.warn("Failed to parse entity date:",t),null}}_syncToEntity(){var t;if(!(null===(t=this._config)||void 0===t?void 0:t.sync_entity)||!this._startDate)return;const e=this._config.sync_direction||"both";if("to-entity"!==e&&"both"!==e)return;const o=Date.now();if(o-this._lastSyncToEntityTimestamp<500)return;this._lastSyncToEntityTimestamp=o;const i=this._formatDateForEntity(this._startDate);i&&this.hass.callService("input_datetime","set_datetime",Object.assign({entity_id:this._config.sync_entity},i)).then(()=>{setTimeout(()=>{this._isUserAction=!1},2e3)}).catch(t=>{console.warn("Failed to sync date to entity:",t),this._isUserAction=!1})}_formatDateForEntity(t){try{const e=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),i=String(t.getDate()).padStart(2,"0");return{datetime:`${e}-${o}-${i} ${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}:00`}}catch(t){return console.warn("Failed to format date for entity:",t),null}}_renderPeriodButtons(t){return I`
    ...
    `}updated(t){super.updated(t)}};var Me,He;Pe.styles=Te,t([st({attribute:!1})],Pe.prototype,"hass",void 0),t([ct()],Pe.prototype,"_config",void 0),t([st()],Pe.prototype,"collectionKey",void 0),t([ct()],Pe.prototype,"_startDate",void 0),t([ct()],Pe.prototype,"_endDate",void 0),t([ct()],Pe.prototype,"_compareStartDate",void 0),t([ct()],Pe.prototype,"_compareEndDate",void 0),t([ct()],Pe.prototype,"_period",void 0),t([ct()],Pe.prototype,"_compare",void 0),t([ct()],Pe.prototype,"_showCompareCalendar",void 0),t([ct()],Pe.prototype,"_lastSyncToEntityTimestamp",void 0),t([ct()],Pe.prototype,"_lastSyncFromEntityTimestamp",void 0),t([ct()],Pe.prototype,"_userActionTimestamp",void 0),t([ct()],Pe.prototype,"_isUserAction",void 0),t([ct()],Pe.prototype,"_isProcessingClick",void 0),Pe=t([rt("energy-period-selector-base")],Pe),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Me||(Me={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(He||(He={}));var ze=function(t,e,o,i){i=i||{},o=null==o?{}:o;var n=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return n.detail=o,t.dispatchEvent(n),n},Ne="0.2.5";console.groupCollapsed(`%c⚡ Energy Period Selector Plus v${Ne} is installed`,"color: #488fc2; font-weight: bold"),console.log("Readme:","https://github.com/talKitron/energy-period-selector-plus"),console.groupEnd();const Oe=function(t,e,o){var i;return void 0===o&&(o=!1),function(){var e=[].slice.call(arguments),n=this,r=o&&!i;clearTimeout(i),i=setTimeout(function(){i=null,o||t.apply(n,e)},6e4),r&&t.apply(n,e)}}(t=>{console.log(`%c⚡ Energy Period Selector Plus v${Ne} %cError: ${t}`,"color: #488fc2; font-weight: bold","color: #b33a3a; font-weight: normal")});!function(){const t=window;t.customCards=t.customCards||[],t.customCards.push(Object.assign(Object.assign({},{type:"energy-period-selector-plus",name:"Energy Period Selector Plus",description:"A custom card to change the Energy Period of your Energy Data."}),{preview:!0,documentationURL:"https://github.com/flixlix/energy-period-selector-plus"}))}();let je=class extends it{getCardSize(){return 1}static async getConfigElement(){return await Promise.resolve().then(function(){return oo}),document.createElement("energy-period-selector-editor")}setConfig(t){this._config=t}render(){var t,e,o,i;if(!this.hass||!this._config)return Oe(Ae("common.invalid_configuration")||"Invalid configuration"),L;const n="compact"===((null===(t=this._config)||void 0===t?void 0:t.layout_mode)||"standard"),r=I` <energy-period-selector-base .hass=${this.hass} ._config=${this._config} .collectionKey=${null===(e=this._config)||void 0===e?void 0:e.collection_key}></energy-period-selector-base> `;return n?r:(null===(o=this._config)||void 0===o?void 0:o.card_background)?I` <ha-card .header=${null===(i=this._config)||void 0===i?void 0:i.title}> ${r}</ha-card> `:I` ${r} `}};je.styles=Ce,t([st({attribute:!1})],je.prototype,"hass",void 0),t([st({attribute:!1})],je.prototype,"locale",void 0),t([ct()],je.prototype,"_config",void 0),je=t([rt("energy-period-selector-plus")],je);class Ie extends TypeError{constructor(t,e){let o;const{message:i,explanation:n,...r}=t,{path:a}=t,s=0===a.length?i:`At path: ${a.join(".")} -- ${i}`;super(n??s),null!=n&&(this.cause=s),Object.assign(this,r),this.name=this.constructor.name,this.failures=()=>o??(o=[t,...e()])}}function Re(t){return"object"==typeof t&&null!=t}function Le(t){return Re(t)&&!Array.isArray(t)}function Be(t){return"symbol"==typeof t?t.toString():"string"==typeof t?JSON.stringify(t):`${t}`}function Ue(t,e,o,i){if(!0===t)return;!1===t?t={}:"string"==typeof t&&(t={message:t});const{path:n,branch:r}=e,{type:a}=o,{refinement:s,message:c=`Expected a value of type \`${a}\`${s?` with refinement \`${s}\``:""}, but received: \`${Be(i)}\``}=t;return{value:i,type:a,refinement:s,key:n[n.length-1],path:n,branch:r,...t,message:c}}function*Ve(t,e,o,i){(function(t){return Re(t)&&"function"==typeof t[Symbol.iterator]})(t)||(t=[t]);for(const n of t){const t=Ue(n,e,o,i);t&&(yield t)}}function*Fe(t,e,o={}){const{path:i=[],branch:n=[t],coerce:r=!1,mask:a=!1}=o,s={path:i,branch:n,mask:a};r&&(t=e.coercer(t,s));let c="valid";for(const i of e.validator(t,s))i.explanation=o.message,c="not_valid",yield[i,void 0];for(let[l,d,p]of e.entries(t,s)){const e=Fe(d,p,{path:void 0===l?i:[...i,l],branch:void 0===l?n:[...n,d],coerce:r,mask:a,message:o.message});for(const o of e)o[0]?(c=null!=o[0].refinement?"not_refined":"not_valid",yield[o[0],void 0]):r&&(d=o[1],void 0===l?t=d:t instanceof Map?t.set(l,d):t instanceof Set?t.add(d):Re(t)&&(void 0!==d||l in t)&&(t[l]=d))}if("not_valid"!==c)for(const i of e.refiner(t,s))i.explanation=o.message,c="not_refined",yield[i,void 0];"valid"===c&&(yield[void 0,t])}class Ke{constructor(t){const{type:e,schema:o,validator:i,refiner:n,coercer:r=t=>t,entries:a=function*(){}}=t;this.type=e,this.schema=o,this.entries=a,this.coercer=r,this.validator=i?(t,e)=>Ve(i(t,e),e,this,t):()=>[],this.refiner=n?(t,e)=>Ve(n(t,e),e,this,t):()=>[]}assert(t,e){return We(t,this,e)}create(t,e){return function(t,e,o){const i=Ye(t,e,{coerce:!0,message:o});if(i[0])throw i[0];return i[1]}(t,this,e)}is(t){return function(t,e){return!Ye(t,e)[0]}(t,this)}mask(t,e){return function(t,e,o){const i=Ye(t,e,{coerce:!0,mask:!0,message:o});if(i[0])throw i[0];return i[1]}(t,this,e)}validate(t,e={}){return Ye(t,this,e)}}function We(t,e,o){const i=Ye(t,e,{message:o});if(i[0])throw i[0]}function Ye(t,e,o={}){const i=Fe(t,e,o),n=function(t){const{done:e,value:o}=t.next();return e?void 0:o}(i);if(n[0]){return[new Ie(n[0],function*(){for(const t of i)t[0]&&(yield t[0])}),void 0]}return[void 0,n[1]]}function Ze(t,e){return new Ke({type:t,schema:null,validator:e})}function Ge(){return Ze("any",()=>!0)}function Je(){return Ze("boolean",t=>"boolean"==typeof t)}function qe(t){const e=t?Object.keys(t):[],o=Ze("never",()=>!1);return new Ke({type:"object",schema:t||null,*entries(i){if(t&&Re(i)){const n=new Set(Object.keys(i));for(const o of e)n.delete(o),yield[o,i[o],t[o]];for(const t of n)yield[t,i[t],o]}},validator:t=>Le(t)||`Expected an object, but received: ${Be(t)}`,coercer(e,o){if(!Le(e))return e;const i={...e};if(o.mask&&t)for(const e in i)void 0===t[e]&&delete i[e];return i}})}function Qe(t){return new Ke({...t,validator:(e,o)=>void 0===e||t.validator(e,o),refiner:(e,o)=>void 0===e||t.refiner(e,o)})}function Xe(){return Ze("string",t=>"string"==typeof t||`Expected a string, but received: ${Be(t)}`)}const to=async()=>{var t,e;if(customElements.get("ha-form"))return;const o=await(null===(e=(t=window).loadCardHelpers)||void 0===e?void 0:e.call(t));if(!o)return;const i=await o.createCardElement({type:"entity"});i&&await i.getConfigElement()};let eo=class extends it{constructor(){super(...arguments),this._schema=Vt((t,e)=>[{type:"grid",name:"",schema:[{name:"card_background",selector:{boolean:{}}},{name:"prev_next_buttons",selector:{boolean:{}}}]},{name:"layout_mode",selector:{select:{options:[{value:"standard",label:Ae("editor.fields.layout_mode_options.standard")},{value:"compact",label:Ae("editor.fields.layout_mode_options.compact")}],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"compare_button_type",selector:{select:{options:[{value:"",label:""},{value:"icon",label:Ae("editor.fields.compare_button_options.icon")},{value:"text",label:Ae("editor.fields.compare_button_options.text")}],mode:"dropdown"}}},...t?[{name:"compare_button_label",selector:{text:{}}}]:[]]},{name:"today_button_type",selector:{select:{options:[{value:!1,label:""},{value:"icon",label:Ae("editor.fields.compare_button_options.icon")},{value:"text",label:Ae("editor.fields.compare_button_options.text")}],mode:"dropdown"}}},{type:"grid",name:"",schema:[{type:"multi_select",options:{day:Ae("editor.fields.period_buttons_options.day"),week:Ae("editor.fields.period_buttons_options.week"),month:Ae("editor.fields.period_buttons_options.month"),year:Ae("editor.fields.period_buttons_options.year"),custom:Ae("editor.fields.period_buttons_options.custom")},name:"period_buttons",default:["day","week","month","year"]},...e?[{name:"custom_period_label",selector:{text:{}}}]:[]]}]),this._computeLabelCallback=t=>Ae(`editor.fields.${t.name}`)||`not found: ${t.name}`}async setConfig(t){We(t,function(...t){const e="type"===t[0].type,o=t.map(t=>t.schema),i=Object.assign({},...o);return e?function(t){const e=Object.keys(t);return new Ke({type:"type",schema:t,*entries(o){if(Re(o))for(const i of e)yield[i,o[i],t[i]]},validator:t=>Le(t)||`Expected an object, but received: ${Be(t)}`,coercer:t=>Le(t)?{...t}:t})}(i):qe(i)}(qe({type:Xe(),view_layout:Qe(Xe())}),qe({card_background:Qe(Je()),today_button:Qe(Je()),prev_next_buttons:Qe(Je()),compare_button_type:Qe(Xe()),today_button_type:Qe(Ge()),period_buttons:Qe(Ge()),custom_period_label:Qe(Xe()),compare_button_label:Qe(Xe()),sync_entity:Qe(Xe()),sync_direction:Qe(Xe()),layout_mode:Qe(Xe())}))),this._config=t}connectedCallback(){super.connectedCallback(),to()}render(){var t,e,o,i,n,r,a,s,c,l;if(!this.hass||!this._config)return L;const d=Object.assign(Object.assign({},this._config),{card_background:null!==(t=this._config.card_background)&&void 0!==t&&t,today_button:null===(e=this._config.today_button)||void 0===e||e,prev_next_buttons:null===(o=this._config.prev_next_buttons)||void 0===o||o,compare_button_type:null!==(i=this._config.compare_button_type)&&void 0!==i?i:"",today_button_type:null!==(n=this._config.today_button_type)&&void 0!==n?n:"text",period_buttons:null!==(r=this._config.period_buttons)&&void 0!==r?r:["day","week","month","year"],sync_entity:null!==(a=this._config.sync_entity)&&void 0!==a?a:"",sync_direction:null!==(s=this._config.sync_direction)&&void 0!==s?s:"both",layout_mode:null!==(c=this._config.layout_mode)&&void 0!==c?c:"standard"}),p=this._schema("text"===d.compare_button_type,(null!==(l=d.period_buttons)&&void 0!==l?l:[]).includes("custom"));return I`
      <ha-form
        .hass=${this.hass}
        .data=${d}
        .schema=${p}
    ...
    `}_valueChanged(t){const e=null==t?void 0:t.detail.value;ze(this,"config-changed",{config:e})}_renderSyncRow(t){var e,o;return I`
      <div class="two-col">
        <div class="field">
          <div class="caption">${Ae("editor.fields.sync_entity")}</div>
          <ha-selector
            .hass=${this.hass}
        ...
        <div class="field">
          <div class="caption">${Ae("editor.fields.sync_direction")}</div>
          <ha-selector
            .hass=${this.hass}
            .selector=${{select:{options:[{value:"both",label:Ae("editor.fields.sync_direction_options.both")},{value:"to-entity",label:Ae("editor.fields.sync_direction_options.to_entity")},{value:"from-entity",label:Ae("editor.fields.sync_direction_options.from_entity")}],mode:"dropdown"}}}
            .value=${null!==(o=t.sync_direction)&&void 0!==o?o:"both"}
            @value-changed=${t=>this._patch("sync_direction",t.detail.value)}
          ></ha-selector>
        </div>
      </div>
    `}_patch(t,e){this._config=Object.assign(Object.assign({},this._config),{[t]:e}),ze(this,"config-changed",{config:this._config})}static get styles(){return a`
      ha-form {
        width: 100%;
      }
    ...
    `}};t([st({attribute:!1})],eo.prototype,"hass",void 0),t([ct()],eo.prototype,"_config",void 0),eo=t([rt("energy-period-selector-editor")],eo);var oo=Object.freeze({__proto__:null,loadHaForm:to,get EnergyPeriodSelectorEditor(){return eo}});export{je as EnergyPeriodSelectorPlus};
